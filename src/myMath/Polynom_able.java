...
public interface Polynom_able extends cont_function{
	 ...
	 * @param p1 is a polynom_able that we are going to add to our polynom_able
	 */
	
	public void add(Polynom_able p1);
	/**
	 * Add m1 to this Polynom
	 * @param m1 Monom that we are going to add to our polynom_able
	 */
	public void add(Monom m1);
	/**
	 * Subtract p1 from this Polynom
	 * @param p1 is a polynom_able that we are going to substract from our polynom_able
	 */
	public void substract(Polynom_able p1);
	/**
	 * Multiply this Polynom by p1
	 * @param p1 is a polynom_able that we are going to multiply with our polynom_able
	 */
	public void multiply(Polynom_able p1);
	/**
	 * Test if this Polynom is logically equals to p1.
	 * @param p1 get polynom_able and check if its equal to our polynom
	 * @return true iff this pulynom represents the same function ans p1
	 */
	public boolean equals (Polynom_able p1);
	/**
	 * Test if this is the Zero Polynom
	 * @return true if this is the zero polynom, false otherwise
	 */
...
//	 * *	(i) x0<=x2<=x2 && (ii) f(x2)<eps
	 ...
	 * @return a new polynom_able which is a copy of this polynom_able
	 */
	public Polynom_able copy();
	/**
	 * Compute a new Polynom which is the derivative of this Polynom
	 * @return the derivative of this polynom_able
	 */
